...
<body class="bg-light">
   ...
   <div class="ticket padding-bt">
      ...
      <div class="your-ticket p-3">
         ...
         <p class="text-success mb-3 font-weight-bold">Tamamlandı</p>
         <div class="bg-white border border-warning rounded-1 shadow-sm p-3 mb-3">
            <div class="row mx-0 mb-3">
               <div class="col-6 p-0">
                  <small class="text-muted mb-1 f-10 pr-1">Nereden</small>
                  <p class="small mb-0 l-hght-14"> LUDHIANA</p>
               </div>
               <div class="col-6 p-0">
                  <small class="text-muted mb-1 f-10 pr-1">Nereye</small>
                  <p class="small mb-0 l-hght-14"> GOA</p>
               </div>
            </div>
            <div class="row mx-0">
               <div class="col-6 p-0">
                  <small class="text-muted mb-1 f-10 pr-1">Yolculuk Tarihi</small>
                  <p class="small mb-0 l-hght-14"> 05 May, 2022</p>
               </div>
               <div class="col-6 p-0">
                  <small class="text-muted mb-1 f-10 pr-1">Puanım</small>
         ...
         <div class="bg-white rounded-1 shadow-sm p-3 mb-3 w-100">
            <div class="row mx-0">
               <div class="col-12 p-0 mb-3">
                  <small class="text-danger mb-1 f-10 pr-1">Kalkış</small>
                  <p class="small mb-0 l-hght-14"> Model Towm, Ludhiana - 8:15 PM</p>
               </div>
               <div class="col-12 p-0">
                  <small class="text-danger mb-1 f-10 pr-1">Varış</small>
         ...
         <div class="list_item d-flex col-12 m-0 p-3 bg-white shadow-sm rounded-1 shadow-sm mb-3">
            ...
            <div class="d-flex w-100">
               <div class="bus_details w-100 pl-3">
                  <p class="mb-2 l-hght-18 font-weight-bold">Biniş Konumunu Haritada Görüntüle</p>
                  <div class="d-flex align-items-center mt-2">
                     <small class="text-muted mb-0 pr-1">Akshya Nagar 1st Block 1st Cross, Rammurthy<br>Nagar, Bangalore
                        <br>560016
                     </small>
                  </div>
               </div>
         ...
         <div class="list_item d-flex col-12 m-0 p-3 bg-white shadow-sm rounded-1 shadow-sm">
            ...
            <div class="d-flex w-100">
               <div class="bus_details w-100 pl-3">
                  <p class="mb-2 l-hght-18 font-weight-bold">Daha Fazla Bilgi</p>
                  <div class="l-hght-10 d-flex align-items-center my-2">
                     <small class="text-muted mb-0 pr-1">Yolcu</small>
                     <p class="small mb-0 ml-auto l-hght-14"> Joan Rase</p>
                  </div>
                  <div class="l-hght-10 d-flex align-items-center my-2">
                     <small class="text-muted mb-0 pr-1">Bilet Numarası</small>
                     <p class="small mb-0 ml-auto l-hght-14"> 1313</p>
                  </div>
                  <div class="l-hght-10 d-flex align-items-center my-2">
                     <small class="text-muted mb-0 pr-1">PNR Numarası</small>
                     <p class="small mb-0 ml-auto l-hght-14"> 56276-32324</p>
                  </div>
                  <div class="l-hght-10 d-flex align-items-center mt-3">
                     <p class="mb-0 pr-1 font-weight-bold">Ödenmiş Ücret</p>
      ...
      <div class="footer-menu row m-0 px-1 bg-white shadow rounded-2">
         <div class="col-4 p-0 text-center">
            <a href="profile.html" class="home text-danger py-3">
               ...
               <p class="mb-0 small">Pdf İndir</p>
            </a>
         </div>
         <div class="col-4 p-0 text-center">
...
<!-- Mirrored from mobileui.store/preview/osahanbus/your-ticket.html by HTTrack Website Copier/3.x [XR&CO'2014], Wed, 07 Jul 2021 07:30:20 GMT -->
